// XIOM LSP — Semantic Token Provider
// Sprint 6B.1: extracted from main.rs
use crate::Backend;

/// Map a word to its semantic token type for syntax highlighting.
/// 0=keyword, 1=type, 2=parameter, 3=variable, 4=string, 5=number
pub(crate) fn xiom_semantic_token_type(word: &str) -> u32 {
    match word {
...
pub(crate) fn compute_semantic_tokens(backend: &Backend, uri: &str) -> Vec<u32> {
