...
fn main() -> Int {
  let c1 = casefold.str_casefold("Straße");
  if c1 != "strasse" { io.println("CF1 c1=" + c1); return 1; }
  let c2 = casefold.str_casefold("ÄÖÜ");
  if c2 != "äöü" { io.println("CF2 c2=" + c2); return 2; }
  let c3 = casefold.str_casefold("ABC");
  if c3 != "abc" { io.println("CF3"); return 3; }
  let c4 = casefold.str_casefold("Grüße");
  if c4 != "grüsse" { io.println("CF4 c4=" + c4); return 4; }
  ...
  let c7 = casefold.str_casefold("ÉTÉ");
  if c7 != "été" { io.println("CF7 c7=" + c7); return 7; }
