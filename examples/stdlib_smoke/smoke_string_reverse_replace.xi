...
fn main() -> Int {
  ...
  if xiom.string.replace.str_replace("aaa", "a", "b") != "bbb" { io.println("replace all"); return 4; }
  if xiom.string.replace.str_replace("abc", "x", "y") != "abc" { io.println("replace none"); return 5; }
  if xiom.string.replace.str_replace_all("aaa", "a", "b") != "bbb" { io.println("replace_all"); return 6; }
  if xiom.string.replace.str_replace_n("aaaa", "a", "b", 2) != "bbaa" { io.println("replace_n"); return 7; }
  if xiom.string.replace.str_replace_first("abab", "ab", "X") != "Xab" { io.println("replace_first"); return 8; }
  if xiom.string.replace.str_replace_last("abab", "ab", "X") != "abX" { io.println("replace_last"); return 9; }
