...
fn main() -> Int {
  ...
  let abc_hex = crypto.sha256_hex(&abc_buf);
  let known_abc = "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad";
  ...
  let hex1 = crypto.sha256_hex(&hello_buf);
  let hex2 = crypto.sha256_hex(&hello_buf);
  ...
  let hex_a = crypto.sha256_hex(&alpha_buf);
  let hex_b = crypto.sha256_hex(&beta_buf);
