...
fn main() -> Int {
  if popcount.popcount(0xF0) != 4 { io.println(string.str_concat("popcount ", to_string(popcount.popcount(0xF0)))); return 1; }
  if popcount.popcount(-1) != 64 { io.println("popcount -1"); return 2; }
  var u: UInt64 = 0xFF00FF00;
  if popcount.popcount64(u) != 16 { io.println(string.str_concat("popcount64 ", to_string(popcount.popcount64(u)))); return 3; }
  ...
  if popcount.next_pow2(5) != 8 { io.println(string.str_concat("next_pow2 ", to_string(popcount.next_pow2(5)))); return 13; }
