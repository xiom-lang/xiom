...
fn main() -> Int {
  ...
  if joined1.as_path().to_str() != "/home/user/docs" { return 1; }

  var joined2 = p.join("src/main.xi");
  if joined2.as_path().to_str() != "/home/user/src/main.xi" { return 2; }

  var joined3 = p.join("a").join("b").join("c");
  if joined3.as_path().to_str() != "/home/user/a/b/c" { return 3; }
