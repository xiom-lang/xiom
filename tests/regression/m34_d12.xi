...
fn list_last(n: *Node) -> *Node {
  if n == (0 as *Node) { return 0 as *Node; }
  var nx: *Node;
  unsafe { nx = (*n).next; }
  if nx == (0 as *Node) { return n; }
  return list_last(nx);
}

fn list_nth(n: *Node, k: Int) -> *Node {
  if n == (0 as *Node) || k <= 0 { return n; }
  var nx: *Node;
  unsafe { nx = (*n).next; }
...
fn main() -> Int {
  ...
  if list_last(empty) != (0 as *Node) { return 3; }
  if list_nth(empty, 0) != (0 as *Node) { return 4; }
  return 0;
}
