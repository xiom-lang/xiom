...
module codegen {
  pub fn emit_demo_float() {
    axiom_ir_define_s("add", "i64");
    axiom_ir_param_int(0);
    axiom_ir_param_int(1);
    axiom_ir_entry();
    axiom_ir_alloca_s(0);
    axiom_ir_store_param(0, 0);
    axiom_ir_alloca_s(1);
    axiom_ir_store_param(1, 1);
    axiom_ir_load_s(2, 0);
    axiom_ir_load_s(3, 1);
    axiom_ir_add(4, 2, 3);
    axiom_ir_ret_reg(4);
    ...
    axiom_ir_define_s("sq", "double");
    axiom_ir_param_double(0);
    axiom_ir_entry();
    axiom_ir_alloca_s(0);
    axiom_ir_store_param(0, 0);
    axiom_ir_load_s(1, 0);
    ...
    axiom_ir_entry();
    axiom_ir_call_fn(0, "sq", "double");
    axiom_ir_call_arg_lit("double", "3.000000");
    axiom_ir_call_end();
    axiom_ir_alloca_s(1);
    axiom_ir_store_param(1, 0);
    axiom_ir_call_fn(2, "add", "i64");
    axiom_ir_call_arg_lit("i64", "10");
    axiom_ir_call_arg_lit("i64", "20");
    axiom_ir_call_end();
    axiom_ir_ret_reg(2);
    axiom_ir_endfn();
  }
