...
fn is_known_type(name_id: Int) -> Bool {
  var ptr = axiom_lookup(name_id);
  if (ptr == 0) { return false; }
  var c0 = axiom_char_at(ptr, 0);
...
fn main() -> Int {
  ...
  // Read source file
  var src = axiom_read_file("selfhost\\xiomc_v10.xi");
  if src == 0 { return 1; }
  ...
  if type_errors > 0 {
    ...
    axiom_ir_header();
    axiom_ir_raw("");
    axiom_ir_emit_program(type_errors + 0);
    axiom_ir_close();
    return type_errors;
  }
