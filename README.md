...
[![Version](https://img.shields.io/badge/version-0.61.3-blue)]()
...
Download the latest `xiom-v0.61.3-windows-x64.zip` from [Releases](https://github.com/xiom-lang/xiom/releases), extract, and double-click `install.bat`. It will:
...
.\package.ps1
# Produces:
#   release\xiom-v0.61.3\                 <- portable folder
#   release\xiom-v0.61.3-windows-x64.zip   <- distributable ZIP
```
...
.\install.ps1 -BinaryPath .\release\xiom-v0.61.3
