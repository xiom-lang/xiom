...
|-------|----------------|--------|
| Phase 0 | **Pipeline** -- foundations | [OK] v0.1.0 |
| Phase 1 | **Guardian** -- full language surface | [OK] v0.2.0 - v0.30.0 |
| Phase 2 | **Hardened** -- stdlib + codegen hardening | [OK] v0.31.0 |
| Phase 3 | **ARC-C** -- &mut Struct, by-reference passing | [OK] v0.32.0 |
| Phase 4 | **Or-Patterns** -- match expression completion | [OK] v0.33.0 |
...
- **size_of[T]() / align_of[T]()** compiler intrinsics -- capture type_arg from `Expr::Index`, compute size from LLVM type layout (i64=8, i8=1, struct=field_countx8)
