...
- **Total with M26: ~15 minutes (4x speedup)**
...
| **Threading** | Deadlock detection -- static lock-ordering (I3) | `THREADING_PLAN.md` S0.6 | 4 days | ? Remaining |
...
- [ ] **Unsafe Confinement (a-i) -- v0.57.0 -- `docs/UNSAFE_CONFINEMENT_PLAN.md`** (see Sv0.57.0)
