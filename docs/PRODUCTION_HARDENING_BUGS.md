...
- Round 9 (10 iterations): `a=0xefe8bf51, e=0x53072289` [OK]
- Round 19 (20 iterations): should be `a=0x0a480908, e=0x900d27ac` but XIOM produces DIFFERENT values [FAIL]
...
- [x] Loop split into 4x16 chunks -- no change
...
3. **Loop chunking**: 64->4x16 -> no change
